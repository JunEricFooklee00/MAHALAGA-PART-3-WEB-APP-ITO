...
const conn4 = mongoose1.createConnection("mongodb+srv://charlesadmin:admin123@employeemanagementsyste.yckarjq.mongodb.net/ReviewJobOrder")
const conn5 = mongoose.createConnection("mongodb+srv://charlesadmin:admin123@employeemanagementsyste.yckarjq.mongodb.net/test")
...
function getJobOrder(){
    const JobOrder = conn4.model("JobOrders", JobSchema)
    return JobOrder
}
